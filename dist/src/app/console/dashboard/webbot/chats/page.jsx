...
const ChatHeader_1 = require("@/components/webbot/chat/ChatHeader");
const MessageInput_1 = require("@/components/webbot/chat/MessageInput");
const MessageList_1 = require("@/components/webbot/chat/MessageList");
const UserList_1 = require("@/components/webbot/chat/UserList");
...
function ChatPage() {
    ...
    const handleSendMessage = (content) => {
        ...
        setMessages((prevMessages) => (Object.assign(Object.assign({}, prevMessages), { [selectedUserId]: [...(prevMessages[selectedUserId] || []), newMessage] })));
        // Simulate a bot reply
        setTimeout(() => {
            const botReply = {
                id: String(Date.now()),
                content: `Thank you for your message, ${selectedUser === null || selectedUser === void 0 ? void 0 : selectedUser.name}! We will get back to you shortly.`,
                timestamp: new Date().toLocaleTimeString(),
                senderId: 'support',
                type: 'text',
            };
            setMessages((prevMessages) => (Object.assign(Object.assign({}, prevMessages), { [selectedUserId]: [...(prevMessages[selectedUserId] || []), botReply] })));
    ...
    return (<>
      ...
      <div className="max-w-56 border-r border-gray-200 bg-white">
        <div className="p-4 border-b border-gray-200">
          ...
          <div className="mt-2">
            <input_1.Input type="text" placeholder="Search chats..." className="w-full p-1 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"/>
          </div>
        </div>
        <div className="p-2">
          <UserList_1.UserList users={demoUsers} selectedUserId={selectedUserId} onSelectUser={setSelectedUserId}/>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        {selectedUser ? (<>
            <ChatHeader_1.ChatHeader user={selectedUser}/>
            <MessageList_1.MessageList messages={messages[selectedUserId] || []} currentUserId={currentUserId}/>
            <MessageInput_1.MessageInput onSendMessage={handleSendMessage}/>
