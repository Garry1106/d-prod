...
const SecureField = ({ label, value, icon }) => {
    ...
    return (<framer_motion_1.motion.div className="mb-4 p-4 bg-gradient-to-r from-white to-gray-50 rounded-xl border border-gray-100 hover:border-[#41b658]/30 shadow-sm hover:shadow transition-all" whileHover={{ y: -2 }}>
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setRevealed(!revealed)} className="text-xs px-3 py-1 rounded-full bg-[#41b658]/10 text-[#41b658] hover:bg-[#41b658]/20 transition-colors">
          {revealed ? "Hide" : "Show"}
        </button>
      </div>
...
const Field = ({ label, value, icon }) => {
    ...
    if (value instanceof Date) {
        ...
        <div className="flex items-center">
          {value ? (<div className="flex items-center bg-[#41b658]/10 text-[#41b658] px-3 py-1 rounded-full">
...
const UsageProgress = ({ label, used, total, icon }) => {
    ...
    return (<framer_motion_1.motion.div className="mb-6 p-4 rounded-xl border border-gray-100 hover:border-[#41b658]/30 shadow-sm hover:shadow bg-white transition-all" whileHover={{ y: -2 }}>
...
const SubscriptionStatus = ({ expiryDate, level, price }) => {
    ...
    return (<framer_motion_1.motion.div className={`p-4 rounded-xl shadow-sm border ${isLow ? 'bg-amber-50 border-amber-200' : 'bg-[#41b658]/5 border-[#41b658]/20'}`} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <div className="flex justify-between items-start">
        ...
        <div className={`px-3 py-1 rounded-full text-sm font-medium ${isLow ? 'bg-amber-100 text-amber-600' : 'bg-[#41b658]/10 text-[#41b658]'}`}>
      ...
      <div className="mt-4">
        <div className="w-full bg-gray-200 rounded-full h-1.5">
          <div className={`h-1.5 rounded-full ${isLow ? 'bg-amber-500' : 'bg-[#41b658]'}`} style={{ width: `${Math.min(100, (daysUntilExpiry / 365) * 100)}%` }}></div>
        </div>
      ...
      <div className="mt-4">
        <button className={`w-full py-2 rounded-lg text-white font-medium text-sm ${isLow ? 'bg-amber-500 hover:bg-amber-600' : 'bg-[#41b658] hover:bg-[#41b658]/90'} transition-colors`}>
          Renew Subscription
        </button>
      </div>
    </framer_motion_1.motion.div>);
            ...
            <framer_motion_1.motion.div className="space-y-8" variants={containerVariants} initial="hidden" animate="visible">
              ...
              <framer_motion_1.motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 bg-white p-6 rounded-2xl shadow-md border border-gray-100">
                <div className="flex items-center mb-4 sm:mb-0">
                  <avatar_1.Avatar className="h-16 w-16 mr-4 border-2 border-[#41b658] shadow-lg">
                    ...
                    <avatar_1.AvatarFallback className="bg-[#41b658] text-white text-xl">
                      {((_a = user === null || user === void 0 ? void 0 : user.businessName) === null || _a === void 0 ? void 0 : _a.split(' ').map(word => word[0]).join('')) || 'TS'}
                    </avatar_1.AvatarFallback>
                  </avatar_1.Avatar>
                  
                  <div>
                    <h1 className="text-2xl font-bold text-gray-800">{(tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.businessName) || ''}</h1>
                    <div className="flex items-center mt-1">
                      <badge_1.Badge className="bg-[#41b658]/10 text-[#41b658] hover:bg-[#41b658]/20 border-none">
                      ...
                      <span className="text-sm text-gray-500">{tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.country}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full sm:w-auto">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    <badge_1.Badge className="bg-[#41b658] text-white hover:bg-[#41b658]/90">
                      {tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.subscriptionLevel}
                    </badge_1.Badge>
                    <div className="px-3 py-1 rounded-full bg-gray-100 text-gray-600 text-sm font-medium">
                      ID: {(_b = tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.clerkId) === null || _b === void 0 ? void 0 : _b.substring(0, 8)}...
                    </div>
                  </div>
                </div>
              </framer_motion_1.motion.div>
                ...
                <framer_motion_1.motion.div variants={itemVariants} className="md:col-span-1 space-y-6">
                  ...
                  <framer_motion_1.motion.div variants={cardVariants}>
                    <card_1.Card className="border-gray-200 shadow-sm overflow-hidden">
                      <card_1.CardHeader className="bg-gradient-to-r from-[#41b658]/10 to-transparent pb-3">
                        <div className="flex justify-between items-center">
                          <card_1.CardTitle className="text-lg font-bold text-gray-800">API Credentials</card_1.CardTitle>
                          <lucide_react_1.Lock className="h-5 w-5 text-[#41b658]"/>
                        </div>
                      </card_1.CardHeader>
                      <card_1.CardContent className="pt-4">
                        <SecureField label="WABA ID" value={(tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.waba_id) || ''} icon={<lucide_react_1.Key size={18}/>}/>
                        <Field label="Phone Number" value={(tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.displayPhoneNumber) || ''} icon={<lucide_react_1.Phone size={18}/>}/>
                        <SecureField label="Phone ID" value={(tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.phoneNumberId) || ''} icon={<lucide_react_1.Key size={18}/>}/>
                  ...
                  <framer_motion_1.motion.div variants={cardVariants}>
                    ...
                    : 'bg-gray-50 border border-gray-100'}`}>
                              {feature.enabled ? (<lucide_react_1.CheckCircle className="h-4 w-4 text-[#41b658] mr-2 flex-shrink-0"/>) : (<lucide_react_1.XCircle className="h-4 w-4 text-gray-400 mr-2 flex-shrink-0"/>)}
                ...
                <framer_motion_1.motion.div variants={itemVariants} className="md:col-span-2">
                  <tabs_1.Tabs defaultValue="usage" className="w-full">
                    <tabs_1.TabsList className="w-full bg-white p-1 rounded-xl mb-6 border border-gray-200">
                      <tabs_1.TabsTrigger value="usage" className="flex-1 rounded-lg data-[state=active]:bg-[#41b658] data-[state=active]:text-white">
                        <lucide_react_1.BarChart className="h-4 w-4 mr-2"/>
                        Usage
                      </tabs_1.TabsTrigger>
                      <tabs_1.TabsTrigger value="account" className="flex-1 rounded-lg data-[state=active]:bg-[#41b658] data-[state=active]:text-white">
                        <lucide_react_1.User className="h-4 w-4 mr-2"/>
                        Account
                      </tabs_1.TabsTrigger>
                      <tabs_1.TabsTrigger value="settings" className="flex-1 rounded-lg data-[state=active]:bg-[#41b658] data-[state=active]:text-white">
                    ...
                    <tabs_1.TabsContent value="usage" className="mt-0">
                      <card_1.Card className="border-gray-200 shadow-sm">
                        <card_1.CardHeader className="bg-gradient-to-r from-[#41b658]/10 to-transparent">
                          <div className="flex justify-between items-center">
                        ...
                        <card_1.CardContent className="pt-6">
                          ...
                          <div className="mt-6 p-4 rounded-xl bg-gray-50 border border-gray-200">
                            <div className="flex items-start">
                              <lucide_react_1.Info className="h-5 w-5 text-[#41b658] mr-3 mt-0.5"/>
                              <div>
                    ...
                    <tabs_1.TabsContent value="account" className="mt-0">
                      <card_1.Card className="border-gray-200 shadow-sm">
                        ...
                        <card_1.CardContent className="pt-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <Field label="Business Name" value={(tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.businessName) || ''} icon={<lucide_react_1.Building size={18}/>}/>
                            <Field label="Country" value={(tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.country) || ''} icon={<lucide_react_1.Globe size={18}/>}/>
                            <Field label="Currency" value={(tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.currency) || ''} icon={<lucide_react_1.CreditCard size={18}/>}/>
                            
                            <Field label="Subscription Level" value={(tenantConfig === null || tenantConfig === void 0 ? void 0 : tenantConfig.subscriptionLevel) || ''} icon={<lucide_react_1.Database size={18}/>}/>
                          </div>
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="p-4 rounded-xl border border-gray-200 bg-white">
                              ...
                              <div className="flex items-center justify-between p-4 rounded-lg border border-[#41b658]/20 bg-[#41b658]/5">
                                <div>
                                  <p className="font-semibold text-gray-800">Current Plan: <span className="text-[#41b658]">{user === null || user === void 0 ? void 0 : user.subscriptionLevel}</span></p>
                                  <p className="text-sm text-gray-600 mt-1">
                            ...
                            <div className="p-4 rounded-xl border border-gray-200 bg-white">
                              ...
                              <div className="space-y-3">
                                <button className="w-full flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:border-[#41b658]/30 bg-gray-50 hover:bg-gray-100 transition-all">
                                  <div className="flex items-center">
                                    <lucide_react_1.Lock className="h-5 w-5 text-[#41b658] mr-2"/>
                                ...
                                <button className="w-full flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:border-[#41b658]/30 bg-gray-50 hover:bg-gray-100 transition-all">
                                  <div className="flex items-center">
                                    <lucide_react_1.Key className="h-5 w-5 text-[#41b658] mr-2"/>
                                ...
                                <button className="w-full flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:border-[#41b658]/30 bg-gray-50 hover:bg-gray-100 transition-all">
                                  <div className="flex items-center">
                                    <lucide_react_1.Settings className="h-5 w-5 text-[#41b658] mr-2"/>
