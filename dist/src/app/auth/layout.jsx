...
function AuthLayout({ children }) {
    return (<div className="h-screen w-screen flex flex-col lg:flex-row gap-2 bg-[#ffffff] p-4">
      ...
      <div className="w-full lg:w-1/2 relative flex flex-col justify-center items-center rounded-lg overflow-hidden bg-cover bg-center p-8 shadow-lg" style={{
